                ...
                @foreach ($user->products as $product)
                    <div class="card m-4 overflow-hidden" style="height: 18rem;">
                        <div class="card-body row">
                            ...
                            <div class="col-3 justify-content-end align-self-center product" data-product-id="{{ $product->id }}">
                                {{ $product->id }}
                                ...
                                <button class="btn btn-danger remove-from-cart" role="button">Remove</button>
                            </div>
